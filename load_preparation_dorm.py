...
pv = pd.read_csv('./processed_data/pv/MACH_2021_PV_no_interpol.csv', index_col = 0)
net = pd.read_csv('./processed_data/netload/MACH_2021_netload.csv', index_col=0 )
...
load.to_csv("./processed_data/load/MACH_2021_load.csv")
