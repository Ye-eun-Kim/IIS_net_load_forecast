# Load Forecast model per season


# ex.
# python forecast_seasonally.py
...
def program(data, building):
    ...
    # data plotting
    dir = './experiment_outputs/seasonally/'
    ...
    create_folder('./experiment_outputs/test_output/season/')
    test_output_.to_csv(f'./experiment_outputs/test_output/season/{file_name}.csv', index = True, header = True)
