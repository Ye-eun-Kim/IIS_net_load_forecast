...
def program(building, drop_features):
    ...
    create_folder('./experiment_outputs/test_output/pv/')
    test_output_.to_csv(f'./experiment_outputs/test_output/pv/{file_name}.csv', index = True, header = True)



# feature_list = ['DS', 'SL', 'SR', ['TM_6', 'TM_9', 'TM_12', 'TM_15', 'TM_18'], ['WS_6', 'WS_9', 'WS_12', 'WS_15', 'WS_18'], ['SK_6', 'SK_9', 'SK_12', 'SK_15', 'SK_18'], ['PP_6', 'PP_9', 'PP_12', 'PP_15', 'PP_18'], ['PR_9', 'PR_15', 'PR_21'], ['DS', 'SL', 'SR', 'WS_6', 'WS_9','WS_12', 'WS_15', 'WS_18']]
